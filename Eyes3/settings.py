"""
Django settings for Eyes3 project.
...
SECRET_KEY = '$+yu#(dc0n8njl5cckcdqa_1($xyy=xum$7nvuwg*%-p^y#rp_'
...
WSGI_APPLICATION = 'Eyes3.wsgi.application'
